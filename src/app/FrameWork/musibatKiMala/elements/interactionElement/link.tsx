...
export class link extends interactionElement{
    constructor(
        id: string,
        Name: string,
        title: string,
    ){
        super(elementType.link, elementCategory.interaction, id, Name, title);
    }

    handleClickOnLink(ev: React.MouseEvent<unknown>) {
        ...
        return (
            <div>
                <Text>
                    ...
                    Without an href,{' '}
                    <Link onClick={this.handleClickOnLink} underline>
