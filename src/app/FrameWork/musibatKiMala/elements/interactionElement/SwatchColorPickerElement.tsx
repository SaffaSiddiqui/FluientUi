...
export class SwatchColorPickerElement extends interactionElement{
    constructor(
        id: string,
        Name: string,
        title: string,
    ){
        super(elementType.SwatchColorPicker, elementCategory.interaction, id, Name, title);
    }    
            ...
            <>
                <div>
                    ...
                    <SwatchColorPicker
                        columnCount={5}
                        cellShape={'circle'}
                        colorCells={this.colorCellsExample1}
                    ...
                    <SwatchColorPicker
                        ...
                        cellWidth={35}
                        cellBorderWidth={3}
                        colorCells={this.colorCellsExample2}
                    ...
                    <SwatchColorPicker
                        ...
                        cellWidth={40}
                        cellShape={'circle'}
                        colorCells={this.colorCellsExample3}
