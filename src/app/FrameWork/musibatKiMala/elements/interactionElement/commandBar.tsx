...
export class commandBar extends interactionElement{
    constructor(
        id: string,
        Name: string,
        title: string,
    ){
        super(elementType.CommandBar, elementCategory.interaction, id, Name, title);
    }

    overflowProps: IButtonProps = { ariaLabel: 'More commands' };
//
