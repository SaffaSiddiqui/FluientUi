...
export class modal extends interactionElement{
    constructor(
        id: string,
        Name: string,
        title: string,
    ){
        super(elementType.modal, elementCategory.interaction, id, Name, title);
    }
...
//
    ...
    header: [
        // eslint-disable-next-line @typescript-eslint/no-deprecated
        this._theme.fonts.xLargePlus,
        {
        flex: '1 1 auto',
        borderTop: `4px solid ${this._theme.palette.themePrimary}`,
    ...
    _toggleStyles = { root: { marginBottom: '20px' } };
    _iconButtonStyles = {
    root: {
        color: this._theme.palette.neutralPrimary,
        marginLeft: 'auto',
    ...
    const [_isModalOpen, { setTrue: _showModal, setFalse: _hideModal }] = useBoolean(false);
    const [_isDraggable, { toggle: _toggleIsDraggable }] = useBoolean(false);
...
//
        ...
        return(
            <>
                    ...
                    <DefaultButton onClick={showModal} text="Open Modal" />
                        ...
                        >
                            <div className={this.contentStyles.header}>
                                <h2 className={this.contentStyles.heading} id={titleId}>
                                    Lorem Ipsum
                                </h2>
                                <IconButton
                ...
                <div>
                    <Toggle
                        styles={this._toggleStyles}
                        label="Is draggable"
                        inlineLabel
                        onChange={_toggleIsDraggable}
                        checked={_isDraggable}
                        disabled={_isModalOpen}
                    />
                    <DefaultButton secondaryText="Opens the Sample Modal" onClick={_showModal} text="Open Modal" />
                    <Modal
                        titleAriaId={_titleId}
                        isOpen={_isModalOpen}
                        onDismiss={_hideModal}
                        isModeless={true}
                        containerClassName={this._contentStyles.container}
                        dragOptions={_isDraggable ? dragOptions : undefined}
                    >
                        <div className={this._contentStyles.header}>
                        <h2 className={this._contentStyles.heading} id={_titleId}>
                            Lorem Ipsum
                        </h2>
                        <IconButton
                        ...
                        <div className={this._contentStyles.body}>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas lorem nulla, malesuada ut sagittis sit
                                amet, vulputate in leo. Maecenas vulputate congue sapien eu tincidunt. Etiam eu sem turpis. Fusce tempor
                                sagittis nunc, ut interdum ipsum vestibulum non. Proin dolor elit, aliquam eget tincidunt non, vestibulum ut
